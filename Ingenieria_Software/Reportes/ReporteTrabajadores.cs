...
namespace Ingenieria_Software.Reportes
{
    public partial class ReporteTrabajadores : Form
    {
        ...
        private string SQL;
        private string defaultSQL = "SELECT `idTrabajador`, " +
                                        "`nombres`, " +
                                        "`a_paterno`, " +
                                        "`a_materno`, " +
                                        "`curp`, " +
        ...
        private void Button_print_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string name = "Reporte_Trabajadores_" + DateTime.Now.ToString("MM") + DateTime.Now.ToString("yyyy") + DateTime.Now.ToString("dd") + DateTime.Now.ToString("mm") + "_" + filtrote + ".xls";
        ...
        {
            dataGridView1.Columns.Add("ID", "ID Trabajador");
